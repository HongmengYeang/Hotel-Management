...
@section('body')
    ...
    <div class="body-form">
        <div class="form-container">
            ...
            <form class="borrow-form" method="POST" action="{{ route('booking.store') }}">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="datetime-local" id="check_in_date" name="check_in_date" required>
                    </div>
                    <div class="form-group full-width">
                        <label for="check_out_date">Check-out Date</label>
                        <input type="datetime-local" id="check_out_date" name="check_out_date" required>
                    </div>
                    <div class="form-group full-width">
